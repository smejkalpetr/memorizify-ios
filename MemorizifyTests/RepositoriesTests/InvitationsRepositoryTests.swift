//
//  InvitationsRepositoryTests.swift
//  MemorizifyTests
//
...
final class InvitationsRepositoryImplTests: XCTestCase {
    ...
    func testGetInvitationsForUser() {
        XCTAssertTrue(true)
    }

    func testGetMyInvitations() {
        XCTAssertTrue(true)
    }
