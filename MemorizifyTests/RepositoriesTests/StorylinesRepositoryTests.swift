//
//  StorylinesRepositoryTests.swift
//  MemorizifyTests
//
...
final class StorylinesRepositoryTests: XCTestCase {
    ...
    func testUpdateStoryline() {
        XCTAssertTrue(true)
    }

    func testDeleteStoryline() {
        XCTAssertTrue(true)
    }

    func testDeleteAllStorylines() {
        XCTAssertTrue(true)
    }
}
